...
Częstym <span class="marker-highlight">błędem</span> konstrukcyjnym jest <span class="marker-highlight">zatarcie hierarchii</span> między bohaterami. Dzieje się tak, gdy postać drugoplanowa zaczyna otrzymywać tyle uwagi, że jej osobiste problemy przesłaniają główną oś fabuły.
